...
#line 1 "php-nano/ext/standard/var_unserializer.re"
/*
  +----------------------------------------------------------------------+
...
#line 402 "php-nano/ext/standard/var_unserializer.re"
...
#line 904 "php-nano/ext/standard/var_unserializer.c"
{
	YYCTYPE yych;
...
yy1:
	++YYCURSOR;
yy2:
#line 1446 "php-nano/ext/standard/var_unserializer.re"
	{ return 0; }
#line 964 "php-nano/ext/standard/var_unserializer.c"
yy3:
...
yy14:
	++YYCURSOR;
#line 1440 "php-nano/ext/standard/var_unserializer.re"
	{
	/* this is the case where we have less data than planned */
	php_error_docref(NULL, E_WARNING, "Unexpected end of serialized data");
	return 0; /* not sure if it should be 0 or 1 here? */
}
#line 1017 "php-nano/ext/standard/var_unserializer.c"
yy15:
	yych = *++YYCURSOR;
	if (yybm[0+yych] & 128) {
		goto yy27;
...
yy18:
	++YYCURSOR;
#line 964 "php-nano/ext/standard/var_unserializer.re"
	{
	*p = YYCURSOR;
	ZVAL_NULL(rval);
	return 1;
}
#line 1039 "php-nano/ext/standard/var_unserializer.c"
yy19:
	yych = *++YYCURSOR;
	if (yych <= '/') goto yy16;
	if (yych <= '9') goto yy29;
...
yy46:
	++YYCURSOR;
#line 908 "php-nano/ext/standard/var_unserializer.re"
	{
	zend_long id;
...
#line 1273 "php-nano/ext/standard/var_unserializer.c"
yy47:
	yych = *++YYCURSOR;
	if (yych == '"') goto yy61;
	goto yy16;
...
yy49:
	++YYCURSOR;
#line 970 "php-nano/ext/standard/var_unserializer.re"
	{
	*p = YYCURSOR;
	ZVAL_FALSE(rval);
	return 1;
}
#line 1290 "php-nano/ext/standard/var_unserializer.c"
yy50:
	++YYCURSOR;
#line 976 "php-nano/ext/standard/var_unserializer.re"
	{
	*p = YYCURSOR;
	ZVAL_TRUE(rval);
	return 1;
}
#line 1299 "php-nano/ext/standard/var_unserializer.c"
yy51:
	++YYCURSOR;
	if ((YYLIMIT - YYCURSOR) < 3) YYFILL(3);
	yych = *YYCURSOR;
...
yy52:
	++YYCURSOR;
#line 1024 "php-nano/ext/standard/var_unserializer.re"
	{
...
#line 1328 "php-nano/ext/standard/var_unserializer.c"
yy53:
	yych = *++YYCURSOR;
	if (yych <= ',') {
		if (yych == '+') goto yy63;
...
yy56:
	++YYCURSOR;
#line 982 "php-nano/ext/standard/var_unserializer.re"
	{
#if SIZEOF_ZEND_LONG == 4
...
#line 1376 "php-nano/ext/standard/var_unserializer.c"
yy57:
	++YYCURSOR;
#line 939 "php-nano/ext/standard/var_unserializer.re"
	{
	zend_long id;
...
#line 1404 "php-nano/ext/standard/var_unserializer.c"
yy58:
	yych = *++YYCURSOR;
	if (yych == '"') goto yy66;
	goto yy16;
yy59:
	++YYCURSOR;
#line 1140 "php-nano/ext/standard/var_unserializer.re"
	{
	size_t len, maxlen;
	zend_long elements;
	char *str;
...
#line 1631 "php-nano/ext/standard/var_unserializer.c"
yy60:
	++YYCURSOR;
#line 1360 "php-nano/ext/standard/var_unserializer.re"
	{
	if (!var_hash) return 0;
...
#line 1714 "php-nano/ext/standard/var_unserializer.c"
yy61:
	++YYCURSOR;
#line 1070 "php-nano/ext/standard/var_unserializer.re"
	{
	size_t len, maxlen;
	zend_string *str;
...
#line 1754 "php-nano/ext/standard/var_unserializer.c"
yy62:
	++YYCURSOR;
#line 1107 "php-nano/ext/standard/var_unserializer.re"
	{
...
#line 1790 "php-nano/ext/standard/var_unserializer.c"
yy63:
	yych = *++YYCURSOR;
	if (yych <= '/') goto yy16;
	if (yych >= ':') goto yy16;
...
yy66:
	++YYCURSOR;
#line 1033 "php-nano/ext/standard/var_unserializer.re"
	{
	size_t len, maxlen;
	char *str;
...
#line 1846 "php-nano/ext/standard/var_unserializer.c"
yy67:
	++YYCURSOR;
#line 1008 "php-nano/ext/standard/var_unserializer.re"
	{
	*p = YYCURSOR;
...
#line 1865 "php-nano/ext/standard/var_unserializer.c"
}
#line 1448 "php-nano/ext/standard/var_unserializer.re"
