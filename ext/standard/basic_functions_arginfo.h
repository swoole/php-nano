...
#if !defined(PHP_NANO)
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_output_reset_rewrite_vars, 0, 0, _IS_BOOL, 0)
ZEND_END_ARG_INFO()
...
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_MASK_EX(arginfo_get_include_path, 0, 0, MAY_BE_STRING|MAY_BE_FALSE)
ZEND_END_ARG_INFO()
#endif
...
#define arginfo_connection_status arginfo_connection_aborted
...
#if !defined(PHP_NANO) && defined(HAVE_GETSERVBYNAME)
...
#if !defined(PHP_NANO) && defined(HAVE_GETSERVBYPORT)
...
#if !defined(PHP_NANO) && defined(HAVE_GETPROTOBYNAME)
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_MASK_EX(arginfo_getprotobyname, 0, 1, MAY_BE_LONG|MAY_BE_FALSE)
	ZEND_ARG_TYPE_INFO(0, protocol, IS_STRING, 0)
ZEND_END_ARG_INFO()
#endif

#if !defined(PHP_NANO) && defined(HAVE_GETPROTOBYNUMBER)
...
#if !defined(PHP_NANO) && defined(HAVE_STRPTIME)
...
#if !defined(PHP_NANO) && defined(HAVE_GETHOSTNAME)
...
#if !defined(PHP_NANO) && (defined(PHP_WIN32) || defined(HAVE_DNS_SEARCH_FUNC))
...
#if !defined(PHP_NANO) && (defined(PHP_WIN32) || defined(HAVE_GETIFADDRS) || defined(__PASE__))
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_MASK_EX(arginfo_net_get_interfaces, 0, 0, MAY_BE_ARRAY|MAY_BE_FALSE)
ZEND_END_ARG_INFO()
#endif

#if !defined(PHP_NANO) && defined(HAVE_FTOK)
...
#define arginfo_getmypid arginfo_getmyuid

#define arginfo_getmyinode arginfo_getmyuid

#define arginfo_getlastmod arginfo_getmyuid
...
#if !defined(PHP_NANO) && defined(HAVE_SYSLOG_H)
...
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_headers_list, 0, 0, IS_ARRAY, 0)
ZEND_END_ARG_INFO()
#endif
...
#if !defined(PHP_NANO) && (defined(HAVE_SYMLINK) || defined(PHP_WIN32))
...
#if !defined(PHP_NANO) && defined(HAVE_GETRUSAGE)
...
#if !defined(PHP_NANO)
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_pack, 0, 1, IS_STRING, 0)
	ZEND_ARG_TYPE_INFO(0, format, IS_STRING, 0)
	ZEND_ARG_VARIADIC_TYPE_INFO(0, values, IS_MIXED, 0)
ZEND_END_ARG_INFO()
...
#define arginfo_password_algos arginfo_headers_list
#endif

#if !defined(PHP_NANO) && defined(PHP_CAN_SUPPORT_PROC_OPEN)
...
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_stream_socket_get_crypto_status, 0, 1, IS_LONG, 0)
	ZEND_ARG_INFO(0, stream)
ZEND_END_ARG_INFO()
#endif
...
#define arginfo_stream_get_filters arginfo_headers_list
...
#endif
#if !defined(PHP_NANO) && (defined(PHP_WIN32) || (defined(HAVE_DNS_SEARCH_FUNC) && defined(HAVE_FULL_DNS_FUNCS)))
...
#endif
#if !defined(PHP_NANO) && (defined(PHP_WIN32) || (defined(HAVE_DNS_SEARCH_FUNC) && defined(HAVE_FULL_DNS_FUNCS))) && (!defined(PHP_WIN32))
...
#endif
#if !defined(PHP_NANO) && (defined(HAVE_ZLIB) && !defined(COMPILE_DL_ZLIB))
...
#endif
#if !defined(PHP_NANO) && defined(LOG_NOWAIT)
